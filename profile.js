...
axios.get(`https://tarmeezacademy.com/api/v1/users/${userid}`)
    .then(response => {
        ...
        hisName.textContent = data.name;
        postsCount.textContent = data.posts_count;
        ...
        axios.get(`https://tarmeezacademy.com/api/v1/users/${userid}/posts`)
            .then(response => {
                ...
                response.data.data.map((post) => {	
                    ...
                    <div  id="postList" class="hidden absolute  right-40 w-40 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                ...
                <a href="#" class="block w-full px-4 py-2 border-b border-gray-200 cursor-pointer hover:bg-gray-100 hover:text-teal-600 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:border-gray-600 dark:hover:bg-gray-600 dark:hover:text-white dark:focus:ring-gray-500 dark:focus:text-white">
                    Delete
                </a>
            </div>
        `
                ...
                <div class="flex items-center	justify-between">
                    <div onclick ="userProfile(${post.author.id})" class="gap-3.5	flex items-center ">
                ...
                <div id="postBody" class="whitespace-pre-wrap mt-7" onclick ="handelFocusing(${post.id})">${post.body}</div>
                ...
                <img src="${post.image}" class="bg-red-500 rounded-2xl w-1/3 object-cover h-96 flex-auto" alt="photo">
                    ...
                    <div class=" h-16 border-b  flex items-center justify-around	">
                        <div class="flex items-center	gap-3	">
                            ...
                            <div class="text-sm cursor-pointer" onclick ="handelFocusing(${post.id})">${post.comments_count} Comments</div>
                        </div>
                        <div class="flex items-center	gap-3">
    ...
    `
                    ...
                    let comingElement = document.getElementById('comIng');
